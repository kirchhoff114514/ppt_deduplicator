...
使用ZLA下智云PPT，总有很多重复的slides（应该是智云识别PPT本身没有做去重），看PPT的时候有些不方便，于是沟槽的拖延症驱使不想看PPT的我产生了写一个去重工具的想法。

**叠甲：本人是机械狗，代码水平极菜，本项目所有代码（包括下面的README.md)都由伟大的Gemini生成，因此难免会有很多问题。如果在使用中出现bug可以在评论区锐评或在github上提issue，我会在能力范围内尽力解决**

\## 项目地址

https://github.com/kirchhoff114514/ppt_deduplicator
...
1. **下载：** 访问 [kirchhoff114514/ppt_deduplicator](https://github.com/kirchhoff114514/ppt_deduplicator)，下载最新版本的 **`PPTDeduplicator.exe`** 文件。
